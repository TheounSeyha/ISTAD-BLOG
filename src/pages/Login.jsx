      ...
      <div className="block md:flex items-center justify-center dark:bg-slate-800 dark:text-white min-h-screen">
        ...
        <form className="md:w-2/4 px-12 self-center py-8" onSubmit={handleSubmit}>
          ...
          <p className="md:flex items-start mb-5">
            Dont have account?
            <NavLink to="/register" className="text-[#1a6aff]">Create account.</NavLink>
          </p>
          <button
            type="submit"
          ...
          >
            Login
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor" style={{ color: "white" }}>
